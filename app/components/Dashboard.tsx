  ...
  return (
    <div className="flex h-screen w-full">
        ...
        <div className="flex flex-col h-full p-4 justify-between">
          <div className="flex flex-col gap-8">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <a className="flex items-center gap-3 px-3 py-3 rounded-lg hover:bg-[#1c2721] text-[#9db9ab] hover:text-white transition-all" href="/shop">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full bg-[#111814] border-t border-[#283930] flex justify-around p-4 z-50">
        ...
        <a className="flex flex-col items-center gap-1 text-[#9db9ab]" href="/shop">
          <span className="material-symbols-outlined">storefront</span>
